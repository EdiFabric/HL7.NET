...
{
    class ReadHL7FileWithDSC
    {
        /// <summary>
        /// Reads the HL7 stream with DSC segment
        /// </summary>
        public static void Run()
        {
            ...
            //  1.  Load to a stream 
            Stream hl7Stream = File.OpenRead(Directory.GetCurrentDirectory() + Config.TestFilesPath + @"\ObservationDSC.txt");
